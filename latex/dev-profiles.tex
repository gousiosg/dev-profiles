...
\midrule
dbr/Computer\_software (43.3\%) 			& \\
dbr/Application\_software (40.4\%)			& \\
dbr/Cascading\_Style\_Sheets (38.9\%)	& \\
dbr/Business (37.6\%)								& \\
dbr/JavaScript (36.5\%)							& \\
dbr/HTML (24.8\%)									& \\
dbr/Debian (20.5\%)								& \\
dbr/PHP (20.0\%)										& \\
dbr/Computing\_platform (1§9.8\%)		& \\
dbr/HTML5 (17.4\%)								& \\
\bottomrule
\end{tabular}
