...
\vspace{1cm} %push the annotated text to the next column

{\small
\noindent The \textbf{successful} \annotateG{dbr/Successful\_(song)}\\ \textbf{candidates} \annotateG{dbr/Candidate} \\
...
{\footnotesize\textbf{Object Oriented Programming}} \annotate{dbr/Object-oriented\_programming} such as Design Patterns and \textbf{Refactoring}.  \annotate{dbr/Martin\_Fowler} 
}
\vspace{0.5cm}\\
